...
class Combinatorics {
    ...
    companion object{
        ...
        fun factorial(n: Int): Double {
            if (n<0)
                throw OutOfBoundsException("Cannot compute factorial of a negative number.")
            var factorial = 1.0
            for (i in n downTo 1)
                factorial *= i
            return factorial
        ...
        fun doubleFactorial(n: Int): Double{
            when {
                n < 0 -> throw OutOfBoundsException("Cannot compute factorial of a negative number.")
                n == 0 -> return 1.0  // Zero base case
            }
        ...
        fun risingFactorial(x: Double, n: Int): Double        {
            if (n < 0)
                throw OutOfBoundsException("Cannot compute rising factorial of a negative number.")
        ...
        fun fallingFactorial(x: Double, n: Int): Double{
            when {
                n < 0 -> throw OutOfBoundsException("Cannot compute rising factorial of a negative number.")
                n > x -> return 0.0
            }
            var fact = 1.0
            for (i in n downTo 1)
        ...
        fun subfactorial(n: Int): Double {
            if (n < 0)
                throw OutOfBoundsException("Cannot compute subfactorial of a negative number.")
        ...
        fun permutations(n: Int, k: Int?): Double {
            when{
                n<0->throw OutOfBoundsException("Cannot compute negative permutations.")
                k != null && k > n->throw OutOfBoundsException("k cannot be larger than n.")
            }
            return if (k == null)
        ...
        fun combinations(n: Int, k: Int, repetition: Boolean): Double {
            when {
                n < 0 -> throw OutOfBoundsException("Cannot compute negative combinations.")
                k > n -> throw OutOfBoundsException("k cannot be larger than n.")
            }
        ...
        fun centralBinomialCoefficient(n: Int): Double {
            if (n < 0) {
                throw OutOfBoundsException("Cannot compute negative central binomial coefficient.")
            }
        ...
        {
            if (n < 0) {
                throw OutOfBoundsException("Cannot compute negative catalan number.")
            }
        ...
        fun lahNumber(n: Int, k: Int): Double {
            when{
            n < 1 || k < 1 -> throw OutOfBoundsException("n and k must be > 1 for Lah Numbers")
            n < k -> throw OutOfBoundsException("n must be >= k for Lah Numbers")
            }
